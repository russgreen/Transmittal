...
using Transmittal.FileRenamer.Services;
using Transmittal.FileRenamer.ViewModels;
...
internal static class Host
{
    ...
    {
        var logPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "Transmittal", "Transmittal.Renamer_Log.json");
        ...
        var loggerConfigTransmittal = new LoggerConfiguration()
            ...
            .WriteTo.GoogleAnalytics(opts =>
            {
                ...
                opts.GlobalParams["app_type"] = "Renamer";
